...
<head>
  ...
  <title>SIGA RIOPAILA - Renovar contraseña</title>
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-md-6 col-form-label text-md-left">Correo Electrónico</label>
                  ...
                  @enderror
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-md-6 col-form-label text-md-left">Nueva Contraseña</label>                        
                    ...
                    <div class="form-group row">
                        <label for="password-confirm" class="col-md-6 col-form-label text-md-left">Confirmar Contraseña</label>
